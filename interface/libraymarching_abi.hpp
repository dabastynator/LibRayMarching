...
#ifndef __LIBRAYMARCHING_HEADER_CPP
#define __LIBRAYMARCHING_HEADER_CPP
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_primitive_translate(LibRayMarching_Primitive pPrimitive, const LibRayMarching::sVector * pTranslation);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_primitive_rotate(LibRayMarching_Primitive pPrimitive, const LibRayMarching::sVector * pAxis, LibRayMarching_double dRadian);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_primitive_scale(LibRayMarching_Primitive pPrimitive, const LibRayMarching::sVector * pScale);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_primitive_setmaterial(LibRayMarching_Primitive pPrimitive, const LibRayMarching::sMaterial * pMaterial);

/**
* Set glow for this primitive
*
* @param[in] pPrimitive - Primitive instance.
* @param[in] pGlow - Glow for this primitive
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_primitive_setglow(LibRayMarching_Primitive pPrimitive, const LibRayMarching::sGlow * pGlow);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_capsule_getpoint1(LibRayMarching_Capsule pCapsule, LibRayMarching::sVector * pPoint1);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_capsule_setpoint1(LibRayMarching_Capsule pCapsule, const LibRayMarching::sVector * pPoint1);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_capsule_getpoint2(LibRayMarching_Capsule pCapsule, LibRayMarching::sVector * pPoint2);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_capsule_setpoint2(LibRayMarching_Capsule pCapsule, const LibRayMarching::sVector * pPoint2);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_plane_getnormal(LibRayMarching_Plane pPlane, LibRayMarching::sVector * pNormal);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_plane_setnormal(LibRayMarching_Plane pPlane, const LibRayMarching::sVector * pNormal);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_box_getdimensions(LibRayMarching_Box pBox, LibRayMarching::sVector * pDimensions);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_box_setdimensions(LibRayMarching_Box pBox, const LibRayMarching::sVector * pDimensions);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_primitivegroup_setgroupaction(LibRayMarching_PrimitiveGroup pPrimitiveGroup, LibRayMarching::eGroupAction eGroupAction);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_primitivegroup_getgroupaction(LibRayMarching_PrimitiveGroup pPrimitiveGroup, LibRayMarching::eGroupAction * pGroupAction);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_raymarching_getlight(LibRayMarching_RayMarching pRayMarching, LibRayMarching_uint32 nIndex, LibRayMarching::sVector * pPosition, LibRayMarching::sVector * pColor);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_raymarching_addlight(LibRayMarching_RayMarching pRayMarching, const LibRayMarching::sVector * pPosition, const LibRayMarching::sVector * pColor);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_raymarching_setviewport(LibRayMarching_RayMarching pRayMarching, const LibRayMarching::sVector * pEye, const LibRayMarching::sVector * pDir, const LibRayMarching::sVector * pUp, LibRayMarching_double dFOV);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_raymarching_setbackground(LibRayMarching_RayMarching pRayMarching, const LibRayMarching::sVector * pBackground, LibRayMarching_double dDistanceStart, LibRayMarching_double dDistanceEnd);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_raymarching_setshaderproperties(LibRayMarching_RayMarching pRayMarching, const LibRayMarching::sShaderProperties * pShaderProperties);
...
* @param[out] pColorBufferBuffer - Color buffer of Field of colors. One integer represents color as RGBA value of the pixel
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_raymarching_getcolorbuffer(LibRayMarching_RayMarching pRayMarching, const LibRayMarching_uint64 nColorBufferBufferSize, LibRayMarching_uint64* pColorBufferNeededCount, LibRayMarching::sColor * pColorBufferBuffer);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_raymarching_renderpixel(LibRayMarching_RayMarching pRayMarching, LibRayMarching_double dX, LibRayMarching_double dY, LibRayMarching::sColor * pColor);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_raymarching_setprogresscallback(LibRayMarching_RayMarching pRayMarching, LibRayMarching::ProgressCallback pProgressCallback);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_acquireinstance(LibRayMarching_BaseClass pInstance);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_createcapsule(LibRayMarching_double dRadius, const LibRayMarching::sVector * pPoint1, const LibRayMarching::sVector * pPoint2, LibRayMarching_Capsule * pCapsule);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_createbox(const LibRayMarching::sVector * pDimensions, LibRayMarching_Box * pBox);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_createplane(const LibRayMarching::sVector * pOrigin, const LibRayMarching::sVector * pNormal, LibRayMarching_Plane * pPlane);
...
* @return error code or 0 (success)
*/
LIBRAYMARCHING_DECLSPEC LibRayMarchingResult libraymarching_createprimitivegroup(LibRayMarching::eGroupAction eGroupAction, LibRayMarching_PrimitiveGroup * pPrimitiveGroup);

}

#endif // __LIBRAYMARCHING_HEADER_CPP
