...
#ifndef __LIBRAYMARCHING_TYPES_HEADER_CPP
#define __LIBRAYMARCHING_TYPES_HEADER_CPP
...
#define LIBRAYMARCHING_VERSION_MAJOR 2
#define LIBRAYMARCHING_VERSION_MINOR 0
#define LIBRAYMARCHING_VERSION_MICRO 0
#define LIBRAYMARCHING_VERSION_PRERELEASEINFO "beta"
#define LIBRAYMARCHING_VERSION_BUILDINFO ""
...
namespace LibRayMarching {
  ...
  **************************************************************************************************************************/
  ...
  enum class eGroupAction : LibRayMarching_int32 {
    Unify = 0,
    Intersect = 1,
    Subtract = 2
  };
  ...
  **************************************************************************************************************************/
  ...
  typedef struct {
      LibRayMarching_single m_Red;
      LibRayMarching_single m_Green;
      LibRayMarching_single m_Blue;
  } sColor;
  ...
  typedef struct {
      ...
      LibRayMarching_double m_AmbientOcclusion;
  ...
  typedef struct {
      ...
      LibRayMarching_double m_Green;
      LibRayMarching_double m_Blue;
      LibRayMarching_double m_Intensity;
  } sGlow;
  ...
  */
  typedef void(*ProgressCallback)(LibRayMarching_single, bool *);
  
} // namespace LibRayMarching;

// define legacy C-names for enums, structs and function types
typedef LibRayMarching::eGroupAction eLibRayMarchingGroupAction;
typedef LibRayMarching::sVector sLibRayMarchingVector;
typedef LibRayMarching::sColor sLibRayMarchingColor;
typedef LibRayMarching::sMaterial sLibRayMarchingMaterial;
typedef LibRayMarching::sGlow sLibRayMarchingGlow;
typedef LibRayMarching::sShaderProperties sLibRayMarchingShaderProperties;
typedef LibRayMarching::ProgressCallback LibRayMarchingProgressCallback;

#endif // __LIBRAYMARCHING_TYPES_HEADER_CPP
