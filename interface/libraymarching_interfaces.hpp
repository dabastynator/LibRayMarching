...
public:
	...
	*/
	...
	/**
	* IPrimitive::SetGlow - Set glow for this primitive
	* @param[in] Glow - Glow for this primitive
	*/
	virtual void SetGlow(const LibRayMarching::sGlow Glow) = 0;
...
public:
	...
	*/
	virtual void GetColorBuffer(LibRayMarching_uint64 nColorBufferBufferSize, LibRayMarching_uint64* pColorBufferNeededCount, LibRayMarching::sColor * pColorBufferBuffer) = 0;
	...
	*/
	virtual LibRayMarching::sColor RenderPixel(const LibRayMarching_double dX, const LibRayMarching_double dY) = 0;
